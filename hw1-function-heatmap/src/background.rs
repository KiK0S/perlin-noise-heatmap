...
pub fn draw_background(display: &mut Display, _time: f32, function: &PerlinNoise, isolines: &Isolines) {
    ...
    for (x, y) in BACKGROUND.iterator() {
        ...
        draw_square(display, &mut target, x, y, BACKGROUND.get_cell_width() as f32, (value + 0.4, 0.2, 0.05));
    }
